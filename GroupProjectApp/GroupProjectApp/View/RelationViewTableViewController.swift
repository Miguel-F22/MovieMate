//
//  RelationViewTableViewController.swift
//  GroupProjectApp
//
//  Created by Josh GImenes on 2/5/20.
...
class RelationViewTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if eventsRelationsList.count > 0 {
            return eventsRelationsList.count
        } else if objectsRelationsList.count > 0 {
            return objectsRelationsList.count
        } else {
            return charactersRelationsList.count
        }
    }
